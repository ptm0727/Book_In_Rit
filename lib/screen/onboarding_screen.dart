        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Discover and Book Auditoriums from Anywhere at Anytime. Let's get safe bookings and have fun!",
                style: descTextStyle,
    ...
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            title: const Text("Thank you for downloading BookInRit."),
            content: const Text(
                'Use this app to book any auditorium in MSRIT campus and get reserved bookings for your events'),
          );
        });
  }
}
